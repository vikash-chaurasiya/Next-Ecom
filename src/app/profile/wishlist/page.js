...
const Wishlist = () => {
  ...
  // console.log("this is product in wishlist",products)
              ...
              <>
                <div className="flex justify-center items-center flex-col w-full h-96">
                  <img
                    ...
                    alt="shopping-cart"
                  />
                  <h2 className="mt-3 mb-3 text-xl text-gray-400">Your <span className="text-yellow-500">Wishlist</span>  is empty !</h2>
                        ...
                        <div className="flex mt-auto mb-3 items-center justify-between px-4 py-2 bg-gray-900">
                          ...
                          <div className="flex gap-3">
                            ...
                            {cart?.some(
                              ...
                              <Link href={"/cart"}>
                                <button className="px-2 h-9 w-24 py-1 text-xs font-semibold text-gray-900 uppercase transition-colors duration-300 transform bg-yellow-100 rounded hover:bg-gray-200 focus:bg-gray-400 focus:outline-none">
                                  Go to Cart
                                </button>
                              </Link>
                            ) : (
